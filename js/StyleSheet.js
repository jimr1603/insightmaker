		...
		items: [{
				...
				items: [{
					...
					handler: function(){
                        ...
                        var style = JSON.stringify(getStyleSheet());
                        var b = new Blob([style],{type:"text/css"});
                        saveAs(b,"stylesheet", "text/css");
